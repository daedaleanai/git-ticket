...
func (e *ParseError) Error() string {
	...
	highlightedError.WriteString(RESET_UNDERLINE)
...
func parseAllFilter(parser *Parser) (AstNode, *ParseError) {
	ctx := &parser.context
	...
	return &AllFilter{Inner: filters, span: span}, nil
}

func parseAnyFilter(parser *Parser) (AstNode, *ParseError) {
	ctx := &parser.context
	...
	return &AnyFilter{Inner: filters, span: span}, nil
}
...
func parseColorBy(parser *Parser) (AstNode, *ParseError) {
	ctx := &parser.context
