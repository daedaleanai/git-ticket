...
func TestValidatePayloadForFailing(t *testing.T) {
	...
	errs[failureKey] = session.NewValidationError(failureKey, failureMessage)
...
func validatePayloadForRequest(t *testing.T, r *http.Request) *http.Request {
	...
	ValidatePayload(&SomePayload{}, handle)(w, r)
...
func (p *SomePayload) FromValues(values url.Values) ValidatedPayload {
